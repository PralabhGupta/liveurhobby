...
<head>
	...
	<link rel="stylesheet" href="institute_popup/css/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="institute_popup/css/style.css"> <!-- Gem style -->
	<script src="institute_popup/js/modernizr.js"></script> <!-- Modernizr -->
	...
	<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
		<div class="cd-user-modal-container"> <!-- this is the container wrapper -->
			...
			<div id="cd-login"> <!-- log in form -->
				<form class="cd-form" id="loginform" action="institute/institute-verify.php" method="POST">
					<p class="fieldset">
			...
			<div id="cd-signup"> <!-- sign up form -->
				<form class="cd-form" id="signupform"  action="institute/institute-process.php" method="post">
					<p class="fieldset">
...
if ($x==md5(6))
{echo '<script type="text/javascript">';
	echo"alert('Your account has been activated. Please Login now.')";
	echo"</script>";}
...
<script src="institute_popup/js/main.js"></script> <!-- Gem jQuery -->
</body>
</html>