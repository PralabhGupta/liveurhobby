...
<center>
<div id="newsfeed">
<center><h1>Dance</h1></center>
<?php
$x=$_GET[x];
//$dbc=mysqli_connect("localhost","root","","hobby");
$query11="select * from dance where id='$x'";
...
<?php
echo"<br>course:$row11[course]";
echo"<br>";
echo"duration: $row11[duration]";
echo"<br>";
echo"fees:$row11[fees]";
echo"<br>";
echo"totalseats:$row11[totalseats]";
echo"<br>";
echo"Description:$row11[description]";
echo"<br>";
echo"teacher name:$row11[teachername]";
echo"<br>";
echo"contact:$row11[contact]<br>";
?>
<br>
<a href="user-enroll.php?x=<?php echo $row11[username];?>&y=<?php echo $id;?>&z=dance">ENROLL</a>
