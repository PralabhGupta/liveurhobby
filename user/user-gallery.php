...
<li class="switch"><label onclick="" for="css3menu-switcher"></label></li>
	...
	<li class="toplast"><a class="pressed"  href="user-gallery.php" style="width:180px;height:26px;line-height:26px;">Gallery</a></li>
...
$query15="select * from institutelogin";
...
<br>
<a href="gallery-view-detail.php?x=<?php echo $row11[username];?>">View Detail</a>
<?php
echo"</div>";}
echo"</div>";
?>
