...
<li class="switch"><label onclick="" for="css3menu-switcher"></label></li>
	...
	<li class="topmenu"><a class="pressed"   href="user-event-view.php" style="width:180px;height:26px;line-height:26px;">Events</a></li>
...
$query15="select * from event";
$result11=mysql_query($query15);
echo'<div width="800px">';

while($row11=mysql_fetch_array($result11)){
echo'<div style="width:200px;padding:20px;text-align:center;">';
$query12="select * from $row11[username]";
$result12=mysql_query($query12);
$row12=mysql_fetch_array($result12);
echo'<div style="width:200px;overflow:hidden;">';echo"$row12[name]";echo"</div><br>";
$target="../institute/".$row12[screenshot];
?>
<img src="<?php echo $target;?>" height="200px" width="200px">
<br>
<a href="event-view-detail.php?x=<?php echo $row11[id];?>">View Detail</a>
