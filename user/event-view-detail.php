...
$query11="select * from event where id='$x'";
...
<?php
echo"<br>EventDetailcourse:$row11[eventdetail]";
echo"<br>";
?>
<br>
<a href="user-enroll1.php?x=<?php echo $row11[username];?>&y=<?php echo $id;?>&z=event">ENROLL</a>
