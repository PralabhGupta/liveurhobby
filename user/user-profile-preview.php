...
<table>
<form enctype="multipart/form-data" action="user-profile-update.php" method="post">
<tr height="30px"><td><font size="4"><b>User Name</b></font></td><td><input type="text" name="name" value="<?php echo $row[name];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Address</b></font></td><td><input type="text" name="owner" value="<?php echo $row[owner];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>DOB</b></font></td><td><input type="text" name="housenumber" value="<?php echo $row[housenumber];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Highest Qualification</b></font></td><td><input type="text" name="city" value="<?php echo $row[city];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Father Name</b></font></td><td><input type="text" name="state" value="<?php echo $row[state];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Phone</b></font></td><td><input type="text" name="phone" value="<?php echo $row[phone];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Email</b></font></td><td><input type="text" name="email" value="<?php echo $row[emial];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Alternate Email</b></font></td><td><input type="text" name="year" value="<?php echo $row[year];?>"><br></td></tr>
<tr height="30px"><td><font size="4"><b>Profile Pic</b></font></td><td><input type="file" name="screenshot"></td></tr>
<tr height="30px"><td></td><td><input type="submit"></td></tr>
</form>
</table>
